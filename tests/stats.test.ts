...
describe("symptom stats", () => {
  const symptoms = [
    { symptomType: "腹泻", severity: 4.5, occurredAt: "2026-07-10T01:00:00.000Z" },
    { symptomType: "腹泻", severity: 2.5, occurredAt: "2026-07-10T08:00:00.000Z" },
  ...
  it("groups symptoms by UTC day", () => {
    expect(groupSymptomsByDay(symptoms)).toEqual({
      "2026-07-10": { count: 2, totalSeverity: 7, avgSeverity: 3.5 },
