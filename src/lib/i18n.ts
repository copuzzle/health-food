...
export const dictionaries: Record<Locale, Dictionary> = {
  "zh-CN": {
    ...
    "nav.logs": "记录", "nav.profile": "我的", "language.label": "语言", "language.zh": "中文", "language.en": "English",
  ...
  en: {
    ...
    "app.subtitle": "Food Log", "app.profile": "Profile", "nav.logs": "Log", "nav.profile": "Profile", "language.label": "Language", "language.zh": "中文", "language.en": "English",
